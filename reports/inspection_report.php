...
$sql = "
    SELECT i.inspection_id, i.inspection_title, i.inspection_date, i.inspection_time,
                ...
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?= htmlspecialchars($r['project_name']); ?><br>
                                <small class="text-muted"><?= htmlspecialchars($r['site_name']); ?> -
                                    <?= htmlspecialchars($r['location']); ?></small>
                            </td>
                            <td><?= htmlspecialchars($r['officer_name'] ?: '-'); ?></td>
                            <td><?= htmlspecialchars($r['inspection_date']); ?></td>
                            <td><?= htmlspecialchars($r['inspection_time']); ?></td>
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="8" class="text-center text-muted">No report data found.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
