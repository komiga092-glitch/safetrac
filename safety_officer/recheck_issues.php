...
<div class="topbar d-flex justify-content-between align-items-center">
    <div class="brand-title">Recheck Issue</div>
    <div>
        <a href="recheck_issues.php" class="btn btn-light btn-sm fw-semibold">
...
<div class="card page-card p-4 mb-4">
    <div class="row g-4">
        <div class="col-md-8">
            ...
            <div class="mb-2"><strong>Project:</strong> <?= htmlspecialchars($issue['project_name']); ?></div>
            <div class="mb-2"><strong>Site:</strong> <?= htmlspecialchars($issue['site_name']); ?></div>
            <div class="mb-2"><strong>Location:</strong> <?= htmlspecialchars($issue['location']); ?></div>
            <div class="mb-2"><strong>Description:</strong> <?= htmlspecialchars($issue['description']); ?></div>
            <div class="mb-2"><strong>Severity:</strong> <?= htmlspecialchars($issue['severity']); ?></div>
            <div class="mb-2"><strong>Status:</strong> <span
                    class="badge bg-primary"><?= htmlspecialchars($issue['status']); ?></span></div>
            <div class="mb-2"><strong>Due Date:</strong> <?= htmlspecialchars($issue['due_date'] ?: '-'); ?></div>
            <div class="mb-2"><strong>Fixed Date:</strong> <?= htmlspecialchars($issue['fixed_date'] ?: '-'); ?></div>
            <div class="mb-2"><strong>Reopened Count:</strong> <?= (int)$issue['reopened_count']; ?></div>
            <div class="mb-0"><strong>Supervisor:</strong> <?= htmlspecialchars($issue['supervisor_name'] ?: '-'); ?>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="border rounded p-3 bg-light">
                ...
                <div class="mb-2"><strong>Created:</strong> <?= htmlspecialchars($issue['created_at']); ?></div>
                <div class="mb-2"><strong>Last Rechecked:</strong>
                    <?= htmlspecialchars($issue['last_rechecked_at'] ?: '-'); ?></div>
                <div class="mb-0"><strong>Closed Date:</strong> <?= htmlspecialchars($issue['closed_date'] ?: '-'); ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <table class="table align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars($history['old_status'] . ' → ' . $history['new_status']); ?></td>
